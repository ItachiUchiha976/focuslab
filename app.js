...
function renderCart() {
  ...
  const cart = loadCart();
  if (cart.length === 0) {
    wrapper.innerHTML = '<div style="text-align:center;padding:3rem"><h2>Panier vide</h2><p style="margin:1rem 0">Ajoute des produits FocusLab !</p><a href="index.html" class="btn-primary" style="display:inline-block;padding:12px 24px;background:#4F46E5;color:#fff;border-radius:8px;text-decoration:none;font-weight:600">Voir le catalogue</a></div>';
    return;
  }
